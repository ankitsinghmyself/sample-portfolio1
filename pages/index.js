            ...
            >
              <div className="sm:text-center lg:text-center ">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:text-lg md:mt-5">
                  ...
                  SCSS, MySQL, SQLite/MongoDB, PHP, and Laravel. I have
                  experience in building scalable mobile and web applications,
                  optimizing performance, and ensuring scalability. My
                  communication and collaboration skills enable me to work
                  effectively in cross-functional teams. I have received awards
                  for my commitment, determination, and innovative projects. I
                  hold a Master&apos;s degree in Computer Application from
                  Visvesvaraya Technological University, Bangalore. I have built
                  several projects, including an educational chatbot assistant
                  ...
                  <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 pt-10">
                    <div className=" text-gray-500 justify-center text-lg text-left ">
                      ...
                      <p className="text-lg text-gray-500 leading-relaxed">
                        I&apos;m a <strong>Web & Mobile Developer</strong>{' '}
                        building the Front-end of Websites and Mobile
