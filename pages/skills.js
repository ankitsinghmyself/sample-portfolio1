    ...
    <div className="min-h-screen pt-10 pb-10 bg-gray-100 text-gray-900 flex justify-center">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-5xl flex justify-center cursive">SKILLS</h2>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="p-5 text-gray-500">
            {/* skills */}I am a full stack developer with 3 year experience in
            mobile applications development with a passion for learning new
